...
public class CalendarBar extends HBox {
	...
	public CalendarBar(Calendar date) {
		...
		lblMonth = new Label(
				Enums.Month.values()[date.get(Calendar.MONTH)].getValue() + " - " + date.get(Calendar.YEAR));
		...
		lblLeftArrow.setOnMouseClicked(e -> {
			...
			lblMonth.setText(
					Enums.Month.values()[this.date.get(Calendar.MONTH)].getValue() + " - " + date.get(Calendar.YEAR));
