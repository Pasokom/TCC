...
DELIMITER //
CREATE TRIGGER ADICIONAR_ADM AFTER INSERT ON PROJETO FOR EACH ROW
BEGIN
	INSERT INTO USUARIO_PROJETO (FK_USUARIO, FK_PROJETO, ACEITO) VALUES (new.FK_USUARIO, new.COD_PROJETO, 1);
END
//