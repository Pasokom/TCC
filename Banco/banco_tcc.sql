DROP DATABASE IF EXISTS CYBERLIFE_CALENDAR;
...
CREATE TABLE USUARIO_CONFIGURACOES (
    ...
    HORARIO_TAREFA_INICIO time NOT NULL,
    HORARIO_TAREFA_FIM time NOT NULL,
...
CREATE TABLE META(
	COD_META int AUTO_INCREMENT,
    TITULO varchar(100) NOT NULL,
    QTD_SEMANA int NOT NULL,
    DURACAO_MINUTOS int NOT NULL,
    PERIODO int NOT NULL, -- (0) qualquer hora (1) manhã (2) tarde (3) noite
    FK_USUARIO int NOT NULL,
    PRIMARY KEY (COD_META),
    FOREIGN KEY (FK_USUARIO) REFERENCES USUARIO(COD_USUARIO)
);

CREATE TABLE META_RECORRENCIA (
	COD_RECORRENCIA int AUTO_INCREMENT,
    DATA_RECORRENCIA datetime NOT NULL,
    ...
    PRIMARY KEY (COD_RECORRENCIA),
    FOREIGN KEY (FK_META) REFERENCES META(COD_META) 
);

CREATE TABLE META_SEMANA (
	COD_SEMANA int AUTO_INCREMENT,
    INICIO_SEMANA datetime NOT NULL,
    FIM_SEMANA datetime NOT NULL,
    QTD_CONCLUIDO int DEFAULT 0,
    FK_META int NOT NULL,
    PRIMARY KEY (COD_SEMANA),
    FOREIGN KEY (FK_META) REFERENCES META(COD_META)
);
